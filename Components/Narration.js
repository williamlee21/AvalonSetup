    ...
    render(){
        ...
        return (
            <View>
                ...
                {Expo.Speech.speak('5, 4, 3, 2, 1', {rate:0.2})}
                ...
                {Expo.Speech.speak('All players should have their eyes closed and hands in a fist in front of them. Everyone, open your eyes', {rate:1})}
